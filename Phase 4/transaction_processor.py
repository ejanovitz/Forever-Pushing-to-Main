...
class TransactionProcessor:
    ...
    def daily_cost_per_plan( transaction_file):
        ...
        try: 
            ...
            TransactionProcessor.logger.log_error("File Error", "Transaction file not found", transaction_file)
        except Exception as e:
            # Log any other errors
            TransactionProcessor.logger.log_error("Processing Error", str(e), transaction_file)
